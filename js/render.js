...
function init() {
  ...
  /*
  var name_folder = gui.addFolder("Name of Entity");
  entityName = name_folder.add(parameters, "name");
  // intersects[0].object.name
  entityName.onChange(function(value) {
    for (let i = 0; i < cylinder_list.length; i++) {
      //cylinder_list[i].intersects[0].object.name = 
